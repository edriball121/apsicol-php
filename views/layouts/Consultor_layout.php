    ...
    <body>
        ...
        <nav class="navbar navbar-inverse" id="navbar-admin">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"></a>
                    <a class="navbar-brand" href="#"></a>
                    <a class="navbar-brand" href="index.php?controller=inicio&action=indexConsultor"><p id="bold"><span class="glyphicon glyphicon-piggy-bank"></span> APSICOL</p></a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="index.php?controller=LoginCons&action=logout" class="btn-lg"><span class="glyphicon glyphicon-off"></span> Cerrar Sesión</a></li>
        ...
        <nav class="menu-container">
            ...
            <ul class="menu-items">
                ...
                <li><a class="icon-mail2 btn-lg" href="#">
                        Gestionar Consultas </a>
                </li>
